...
class Dataset(object):
    ...
    def get_file_tags(self, filepath):
        ...
        self.logger.info(f'Pre-mapping: {file_tags}')

        # Apply mappings
        mapped_values = self._apply_mapping(file_tags)
        self.logger.info(f'Post-mapping: {mapped_values}')
