class TestConsistency:
    ...
    def test_file_handlers(self):
        from tag_scanner.file_handlers.base import FileHandler
        from tag_scanner.file_handlers.handler_factory import HandlerFactory
        from tag_scanner.file_handlers.netcdf import NetcdfHandler

    def test_scripts(self):
        from tag_scanner.scripts.command_line_client import (
    ...
    def test_general(self):
        from tag_scanner.facets import Facets, Concept
